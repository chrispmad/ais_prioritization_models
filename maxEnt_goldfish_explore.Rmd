...
me_res |> 
  dplyr::filter(metric %in% c("x_training_samples","training_auc") | str_detect(metric,".*_contribution")) |> 
  knitr::kable()
...
maxentModel@results
summary(maxentModel)
maxentModel@lambdas # contribution of each variable to the model - relative importance

parse_lambdas(maxentModel)
...
modelPredict<-predict(maxentModel, stack_data)
plot(modelPredict)
