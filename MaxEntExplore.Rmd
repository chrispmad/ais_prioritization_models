...
samp_dist <- as.matrix(dist(cbind(samp$x, samp$y)))
samp_dist_inv<-1/samp_dist
diag(samp_dist_inv)<-0
#there are infinites in the inverse matrix- setting them to 0 worked, but what does this do
# to the calculation of Morans I
samp_dist_inv[is.infinite(samp_dist_inv)]<-0
samp_dist_inv[1:5, 1:5]
